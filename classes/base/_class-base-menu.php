...
if (!class_exists('socialtv_Base_Menu')) {
    ...
    class socialtv_Base_Menu {
        ...
        const MENU_SLUG = 'socialtv-plugins';
...
//                        return;
            ...
            echo '<h2>' . $this->__('socialtv Plugins') . '</h2>';
            ...
            echo '</table>';
            echo '<div class="footer"><a href="http://socialtv.com/contact" target="_blank">' . $this->__('Feedback') . '</a> | <a href="http://socialtv.com" target="_blank">socialtv.com</a></div>';
            echo '</div>';
        }
