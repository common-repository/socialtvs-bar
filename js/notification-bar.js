...
(function() {
    ...
    window.socialtv_notification_bar = function(data) {
        var keep_closed_cookie = "notification-bar-keep-closed";

        var spacer = $("#notification-bar-spacer").show();
        var bar = $("#notification-bar");
        var open_button = $("#notification-bar-open-button");
        ...
        if (data.close_button) {
            bar.find(".socialtv-close").click(function() {
        ...
        if (data.button_action_close_bar) {
            bar.find(".socialtv-button").click(function() {
                setHeight(0, null, true);
            });
        }
